...
function insereCorrida($latLngFinal,$latLngInicial,$latLngBusca,$cod_passageiro,$nome_passageiro,$cod_motorista,$setagemInicial,$status,$end_embarque,$end_final_declarado,$contato_pas,$ctEstimado,$nameFileRandChatOfTravel,$pdoConnection){
	  try {

			$pdoConnection->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    // prepare sql and bind parameters
			$stmt=$pdoConnection->prepare("INSERT INTO corridas (lat_lng_final,lat_lng_inicial,lat_lng_busca,cod_passageiro,nome_passageiro,cod_motorista,setagem_inicial,status,end_embarque,end_final_declarado,contato_pas,ctEstimado, chat) VALUES (:latLngFinal,:latLngInicial,:latLngBusca,:cod_passageiro,:nome_passageiro,:cod_motorista,:setagemInicial,:status,:end_embarque,:end_final_declarado,:contato_pas,:ctEstimado,:nameFileRandChatOfTravel);");   
