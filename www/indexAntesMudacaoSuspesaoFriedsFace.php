   ...
   <?php 
               ...
               if ($logout=="yes"){
                   ...
                   // session_destroy();
                    ...
                    echo "<script>alert('Ao entrar novamente no App limpe os dados em Configurar>Apps e Notificações>ttp>Armazenamento>Limpar dados no seu Android...Estamos resolvendo isso...isso é apenas um protótipo nosso do App ');window.location.href = 'https://teletransporte.net';</script>";
                    //session_start();
...
<html lang="pt-br">
   <head>
      <title>Teletransporte.net - TT Passageiros <?php 
...
window.fbAsyncInit = function() {
   ...
   function setGetDadosPassageiro(){
          ...
          '/me',
          'GET',
           {"fields":"id,first_name,last_name,picture,friends"},
           function(response) {
               var url_foto="https://graph.facebook.com/" + response.id + "/picture";
               var amigosFace=response.friends.data;
    ...
    FB.getLoginStatus(function(response) {
              ...
              <?php 
               ...
               ?>
                 FB.logout(function(response) {   
                     try{
                        window.location.href = 'https://teletransporte.net/index.php?sair=yes';  
                      }catch (e) {
      ...
      <?php   
         ...
         echo   "<input type='hidden' id='IHficticio' size='1' value='1'>"; 
          ...
          echo   "<input type='hidden' id='IHqUnidade' value='".$_SESSION['qUnidade']."'>";//km/litro
          echo   "<input type='hidden' id='IHvalorUnidade' value='".$_SESSION['valorUnidade']."'>";// preco por unidade combustivel
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
               ...
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <?php 
                     ...
                     echo   "<input type='hidden' id='IHcelular' value='".$_SESSION["celular"]."'>"; 
                     echo   "<input type='hidden' id='IHvalidado' value='".$_SESSION['validado']."'>";
                     ...
                     echo   "<li><a href='#'><span class='glyphicon glyphicon-user'></span> Bem vindo ".$_SESSION['login']."!</a></li>";
                             ...
                             if (isset($_SESSION["id_facebook"])){
                                  ...
                                  echo   "<li><a id='ASairViaFace' href='index.php?sairViaFace=yes'><span class='glyphicon glyphicon-log-out'></span> Sair</a></li>";
      ...
      <div  id="painelMotoristaEscolhido" class="container">
         <div class="panel panel-primary">
            ...
            <div id="conteudoPainelMotoristaEscolhido" class="panel-body">
               ...
               <button id="btContatoPainelMotoristaEscolhido" class="btn btn-primary" type="button">Contato</button> 
      ...
      <div id="id01" class="modallogin">
         <div class="modal-content">
            ...
            <form method="post" class="modal-contentLogin animate" action="/php/entraPas.php" >
               ...
               <div>
                    <div class="fb-login-button" data-width="" data-size="medium" data-button-type="login_with" data-auto-logout-link="true" scope="public_profile,user_friends" data-use-continue-as="true"></div>
                  <br><br>
                  <p>OU</p>
